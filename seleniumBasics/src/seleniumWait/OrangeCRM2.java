...
public class OrangeCRM2 {
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("Page URL status: " + pageURL.equals("http://orangehrm.qedgetech.com/symfony/web/index.php/auth/login"));
		...
		//identify user profile to logout and click on it
